...
from HachiBot import DEV_USERS, dispatcher, telethn, OWNER_ID
from HachiBot.modules.helper_funcs.chat_status import dev_plus
...
def restart(update: Update, context: CallbackContext):
    ...
    os.system(f"kill -9 {os.getpid()} && python3 -m HachiBot")
